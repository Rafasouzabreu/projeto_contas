					...
					<c:forEach items="${contas}" var="conta">
						...
						<tr>
							...
							<td>
								...
								<a href="/projeto_contas/admin/excluir-conta?id=${conta.idConta}&dataMin=${dataMin}&dataFim=${dataFim}"onclick="return confirm('Deseja exclui o registro: ${conta.nome}?')" class="btn btn-sm btn-outline-danger">Excluir</a>
							</td>
						</tr>
